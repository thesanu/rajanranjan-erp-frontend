  ...
  return (
    <div className="container-fluid">
      <div className="d-flex justify-content-between align-items-center mt-3 mb-2">
        <h5 className="mb-0" style={{ color: 'rgba(17, 82, 73, 0.95)' }}>Areas</h5>
      ...
      <div className="table-responsive border bg-white">
        <Table hover size="sm" className="mb-0 align-middle">
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan={user?.role === 'GlobalAdmin' ? 5 : 4} className="text-center py-4">
                  <BeatLoader
                    size={10}
                    margin={4}
              ...
              <tr>
                <td colSpan={user?.role === 'GlobalAdmin' ? 5 : 4} className="text-center">
                  No data
                </td>
              </tr>
            ) : (
